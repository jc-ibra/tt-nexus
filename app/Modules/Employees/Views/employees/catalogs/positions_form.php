...
$old    = fn(string $key, mixed $default = '') => old($key, $isEdit ? ($position[$key] ?? $default) : $default);
$action = $isEdit ? route_to('employees.positions.update', $position['id']) : route_to('employees.positions.store');
?>
