...
<div class="page-header">
  ...
  <div class="page-actions">
    ...
    <a href="<?= route_to('employees.positions.import') ?>" class="btn btn-secondary">Importar CSV</a>
          ...
          <tr>
            ...
            <td>
              <div class="table-actions">
                <a href="<?= route_to('employees.positions.edit', $p['id']) ?>" class="btn btn-tertiary btn-sm" aria-label="Editar <?= esc($p['name']) ?>">
                ...
                <form action="<?= route_to('employees.positions.destroy', $p['id']) ?>" method="post"
                      onsubmit="return confirm('¿Eliminar el puesto «<?= esc($p['name']) ?>»?')">
                  <?= csrf_field() ?>
                  <button type="submit" class="btn btn-tertiary btn-sm" style="color:var(--color-critical-default);" aria-label="Eliminar <?= esc($p['name']) ?>">
