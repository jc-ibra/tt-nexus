...
$routes->group('servicedesk', [
    ...
    // Agent self-view: my OWN monthly KPI evaluations (read-only, plus the
    // right of reply). Scoped by session inside agentKpisBridge, so the
    // supervisor module stays closed to the agent.
    $routes->get('mis-evaluaciones',                     'MyPerformance::evaluations',   ['as' => 'servicedesk.myevaluations']);
    $routes->get('mis-evaluaciones/(:num)',              'MyPerformance::evaluation/$1', ['as' => 'servicedesk.myevaluations.show']);
    $routes->post('mis-evaluaciones/(:num)/comentarios', 'MyPerformance::saveComments/$1', ['as' => 'servicedesk.myevaluations.comments']);
...
$routes->group('api/v1/servicedesk', [
    ...
    $routes->get('me/performance',                    'MyPerformanceApiController::performance');
