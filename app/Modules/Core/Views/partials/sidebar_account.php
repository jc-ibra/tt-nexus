...
<div class="user-menu sidebar-account" id="user-menu">
  ...
  <div class="user-menu-dropdown" id="user-menu-dropdown" role="menu" aria-labelledby="user-menu-btn">
    ...
    <div class="user-menu-divider"></div>
    <div class="user-menu-roles">
      <p class="user-menu-section-label">Apariencia</p>
      <div class="theme-switcher" role="radiogroup" aria-label="Apariencia">
        <button type="button" class="theme-switcher-btn" data-theme="light" role="radio" aria-checked="false" title="Claro">
        ...
        <button type="button" class="theme-switcher-btn" data-theme="dark" role="radio" aria-checked="false" title="Oscuro">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79Z"/></svg>
          Oscuro
        </button>
        <button type="button" class="theme-switcher-btn" data-theme="system" role="radio" aria-checked="false" title="Igual que el sistema">
